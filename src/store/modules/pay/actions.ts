...
export const postPayRequest = (items: CartItemProps[], userName: string | null | undefined, userEmail: string | null | undefined, userId: number | undefined) => action(UserTypes.POST_PAY_REQUEST,{items, userName, userEmail, userId});
