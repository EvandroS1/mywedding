...
console.log('status', status)
  ...
  return (
    <div className="w-full h-screen relative text-xl font-bold">
      <Image src={"/assets/back.png"} fill={true} alt="convite"/>
    <div className="flex flex-col gap-2 relative w-full h-screen justify-end z-10 pb-[25%] text-gray-800 px-20">
